...
function processStreamOutput(stream, ws) {
    ...
    function processStreamData(data) {
        // This is a helper function to process the incoming data chunks
        if(data) {
        ...
        if(!nextDataType) {
            ...
            if (buffer.length >= nextDataLength) {
                const content = bufferSlicer(nextDataLength); //slice the buffer to get the content of the message
